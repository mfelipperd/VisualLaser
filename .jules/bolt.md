...
## 2026-08-24 - Unthrottled scroll event listeners
**Learning:** Unthrottled scroll event listeners (`window.addEventListener('scroll', handler)`) can block the main thread and cause layout thrashing/jank.
