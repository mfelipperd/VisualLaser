...
import { Calendar, Phone, MessageCircle, Users } from "lucide-react";
        ...
        >
          <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-3xl p-12 text-white max-w-6xl mx-auto">
            ...
            <p className="text-xl leading-relaxed mb-8 max-w-4xl mx-auto">
              Nossa equipe médica está pronta para oferecer o melhor atendimento
              oftalmológico. Agende sua consulta e descubra por que somos
              referência em oftalmologia na região Norte.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-sm text-primary-100">
                  Profissionais com diferentes especialidades oftalmológicas
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-sm text-primary-100">
                  Tire todas as suas dúvidas sobre nossa equipe
                </p>
              </div>
            </div>
          </div>
