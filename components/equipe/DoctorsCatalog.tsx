            ...
            >
              <div className='bg-white rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden h-full flex flex-col'>
                ...
                <div className='relative h-64 overflow-hidden'>
                  {/* Optimization: Added sizes attribute to Next.js Image with fill to prevent downloading unnecessarily large image sizes, improving LCP and reducing bandwidth. */}
                  <Image
                    src={doctor.image}
                    alt={doctor.name}
                    fill
